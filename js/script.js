...
Highcharts.chart('container', {
            ...
            xAxis: {
                title: {
                    text: '<b>Kdo má stavbu zaplatit?</b>',
                    margin: 20,
                    style: {
                        fontSize: "12px"
                    }
                ...
                categories: ['ČEZ', 'ČEZ9', 'ČEZ8', 'ČEZ7', 'ČEZ6', 'ČEZ5', 'ČEZ4', 'ČEZ3', 'ČEZ2', 'ČEZ1', 'neví', 'stát1', 'stát2', 'stát3', 'stát4', 'stát5', 'stát6', 'stát7', 'stát8', 'stát9', 'stát']
            },
            ...
            yAxis: {
                ...
                showLastLabel: true,
                showFirstLabel: true,
                categories: ['nikdy', 'Ne9', 'Ne8', 'Ne7', 'Ne6', 'Ne5', 'Ne4', 'Ne3', 'Ne2', 'Ne1', 'neví', 'Ano1', 'Ano2', 'Ano3', 'Ano4', 'Ano5', 'Ano6', 'Ano7', 'Ano8', 'Ano9', 'hned']
            },

            tooltip: {
                useHTML: true,
                pointFormat: '<h2 class="container-mob">{point.jmeno}</h2><h3 class="container-mob"><i>{point.afiliace}</i></h3>' + '<p><b>Součet dopadu citací: </b><br>{point.z} zásahů</p>' + '<p><b>Názor na termín dostavby: </b><br>{point.nazorTermin}</p>' + '<p><b>Názor na způsob financování: </b><br>{point.nazorFinancovani}</p>',
            },
            ...
            series: [{
                data: [
                    ...
                    },
                    {
                        ...
                        z: 11911162,
                        jmeno: 'Tomáš Hüner',
                        afiliace: 'Exministr průmyslu a obchodu',
                ...
                data: [{
                    ...
                    z: 5643377,
                    jmeno: 'Ján Štuller',
                    afiliace: 'Bývalý vládní zmocněnec pro jadernou energetiku, současný poradce Andreje Babiše pro energetiku',
                    nazorTermin: 'Dostavba by měla být zahájena co nejdříve.',
...
Highcharts.chart('container', {
            ...
            tooltip: {
                useHTML: true,
                pointFormat: '<h2 class="container-dtp">{point.jmeno}</h2><h3 class="container-dtp"><i>{point.afiliace}</i></h3>' + '<p><b>Součet dopadu citací: </b><br>{point.z} zásahů</p>' + '<p><b>Názor na termín dostavby: </b><br>{point.nazorTermin}</p>' + '<p><b>Názor na způsob financování: </b><br>{point.nazorFinancovani}</p>',
            },
